defmodule StratesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StratesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StratesWeb.Gettext, "errors", msg, opts)
    end
  end
