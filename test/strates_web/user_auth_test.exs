defmodule StratesWeb.UserAuthTest do
  use StratesWeb.ConnCase, async: true

  alias Strates.Accounts
  alias StratesWeb.UserAuth
  alias Strates.Factory

  @remember_me_cookie "_strates_web_user_remember_me"
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      StratesWeb.Endpoint.subscribe(live_socket_id)
