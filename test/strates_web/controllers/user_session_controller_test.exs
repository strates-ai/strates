defmodule StratesWeb.UserSessionControllerTest do
  ...
  setup do
    %{user: Factory.insert(:user, password: @valid_password)}
  end
  ...
  describe "POST /auth/login" do
    ...
    test "logs the user in with remember me", %{conn: conn, user: user} do
      ...
      assert conn.resp_cookies["_strates_web_user_remember_me"]
      assert redirected_to(conn) == ~p"/"
    end
